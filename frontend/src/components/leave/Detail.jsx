      ...
      {leave ? (
        <div className="max-w-3xl mx-auto mt-10 bg-white p-8 rounded-md shadow-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <img
                src={`http://localhost:3000/${leave.studentId.userId.profileImage}`}
            ...
            <div>
              <div className="flex space-x-3 mb-5">
                ...
                <p className="font-medium">{leave.studentId.userId.name}</p>
              </div>
              <div className="flex space-x-3 mb-5">
                <p className="text-lg font-bold">Student ID:</p>
                <p className="font-medium">{leave.studentId.employeeId}</p>
              </div>
              <div className="flex space-x-3 mb-5">
